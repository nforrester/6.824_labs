...
clean_files=rpc/rpctest rpc/*.o rpc/*.d rpc/librpc.a *.o *.d yfs_client extent_server lock_server lock_tester lock_demo rpctest test-lab-3-b test-lab-3-c rsm_tester extent_server.log lock_server.log yfs_client1.log yfs_client2.log nforrest-lab1.tgz nforrest-lab2.tgz yfs1 yfs2
.PHONY: clean handin
clean: 
	rm $(clean_files) -rf 
